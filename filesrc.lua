...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>hieupeak chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "hieupeak", HidePremium = false, IntroText = "hieupeak⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("hieupeak SCRIPT")
W:AddLabel("Discordhieupeak")
local Section = W:AddSection({
    Name = "Status"
})
